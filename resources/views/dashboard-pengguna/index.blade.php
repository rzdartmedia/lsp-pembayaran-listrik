    ...
    <div class="container-fluid">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                    Alamat</div>
                                <div class="mb-0 font-weight-bold text-gray-800">{{ auth()->user()->alamat }}</div>
                            </div>
                            <div class="col-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="black"
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                    KWH</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ session('dayaPelanggan') }}</div>
                            </div>
                            <div class="col-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="black"
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mb-4">
                ...
                <!-- Table -->
                @include('dashboard-pengguna.table')
